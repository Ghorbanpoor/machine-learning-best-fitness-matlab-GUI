...
% Last Modified by GUIDE v2.5 11-Feb-2023 23:18:00
...
global X Y X2 Y2 lb ub Min_F Max_F s11 s12 Outputs_Final 
...
lb=eval(get(handles.edit3,'String'));
ub=eval(get(handles.edit4,'String'));
Min_F=eval(get(handles.edit5,'String'));
Max_F=eval(get(handles.edit6,'String'));
...
set(handles.text6,'String',num2str(s11));
set(handles.text8,'String',num2str(s12));
set(handles.text10,'String',num2str(Outputs_Final));
